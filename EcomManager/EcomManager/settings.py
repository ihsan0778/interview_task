"""
Django settings for EcomManager project.
...
SECRET_KEY = 'django-insecure-v@bh@duq(m&zpr7u6xns@)x#esp!ec&y9k4t7dbd%y#u7aly7o'
...
WSGI_APPLICATION = 'EcomManager.wsgi.application'
...
LOGIN_URL = '/accounts/login/'  # Adjust this if your login URL differs
